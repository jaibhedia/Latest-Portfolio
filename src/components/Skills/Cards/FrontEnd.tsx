...
const FrontEnd = () => {
    return ( 
        <div className="w-4/5 border-4 border-zinc-500/20 rounded-xl py-4 px-8 bg-bgMain bg-opacity-80 h-fit lg:w-2/5">
            ...
            <p className="text-neutral-400 mt-2"> I use well-known tools and frameworks to create the behind-the-scenes parts of applications. These help make sure everything runs smoothly, handling data and keeping the system reliable, fast and safe. </p>
